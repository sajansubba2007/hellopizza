...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_del) {
            ...
            openfragment(WbViewFragment.newInstance("https://www.hellopizza.com.au/our-story/"));
        }
        else if (id == R.id.nav_tell_a_friend) {
            openfragment(WbViewFragment.newInstance("https://www.hellopizza.com.au/invite/"));
        }
        else if (id == R.id.nav_the_pizza) {
            openfragment(WbViewFragment.newInstance("https://www.hellopizza.com.au/the-pizza/"));
        }
            ...
            new AlertDialog.Builder(this).setTitle("Hello pizza").setMessage("Are you sure want to logout?").setPositiveButton("Logout", new DialogInterface.OnClickListener() {
                @Override
